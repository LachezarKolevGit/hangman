...
public class PlayerController {
  ...
  public String getGame(
    ...
    gameService.registerSecondPlayer(gameId, currentlyLoggedInPlayer);
    ...
    Map<Character, Boolean> alphabetWithTriedLetters =
        gameService.getAlphabetWithTriedLetters(allInvalidChars);
  ...
  public ModelAndView createNewGame(
      @ModelAttribute GameCreationRequest gameCreationRequest,
      HttpSession session,
      RedirectAttributes redirectAttributes) {
    if (session.getAttribute("player") == null) {
      redirectAttributes.addAttribute("errorMessage", NOT_LOGGED_IN_USER_EXCEPTION_MESSAGE);
    ...
    GameCreationBean gameCreationBean =
        builder
